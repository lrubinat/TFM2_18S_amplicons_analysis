...
There are 5992 OTUs that don't show any occurrence in the normalized data. Let's remove them from the table and take a look at its final dimensions:
...
#rarec_input<-as.matrix(t(colSums(abund_per_SAG_id95_st_subset3st)))
tb18_rarecurve_step1000_10000<-rarecurve(rarec_input, step = 1000, 10000, xlab = "Sample size", ylab = "OTUs", label = TRUE, main="18S amplicons diversity in pico-nano size fraction\n(40,816 OTUs; 5,247,375 reads\n")
