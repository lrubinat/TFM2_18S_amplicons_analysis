...
summary(amplicons_per_sample_tb18) #median of amplicons per sample = ~98600)
...
tb18_tax_occur_min49975<-subset(tb18_tax_occur_min49975, select=-c(st144_MD2926,st122_MD2304,st124_MD2332,st141_MD2821,st116_MD2151,st130_MD2474, st139_MD2751,st119_MD2215,st146_MD2973,st125_MD2340,st121_MD2247,st135_MD2662,st071b_MD1324))


dim(tb18_tax_occur_min49975) #46690    92

#let's check if we loose any OTU when excluding the mentioned stations.
tb18_tax_occur_min49975_no_cero<-tb18_tax_occur_min49975[-(which(rowSums(tb18_tax_occur_min49975)==0)),]
...
#the final dimensions of the normalized table are 92 26657.
#38645 + 8045 = 46690
```
...
tb18_tax_occur_ss49975_no_cero_t.rabund_means.occurence_perc<-as.data.frame(100*(rowSums(tb18_tax_occur_ss49975_no_cero_t.rabund.occur)/92))
...
class_summary_reads_per_class<-aggregate(rowSums(tb18_phototrophs[1:92]), list(tb18_phototrophs$SILVA_plus_MAS_plus_BM_classif), sum)
# count the different groups

class_summary_otus_per_class<-aggregate(rowSums(tb18_phototrophs[1:92]), list(tb18_phototrophs$SILVA_plus_MAS_plus_BM_classif), length)
...
tb18S_OTUs_reads_samples_rel_abund$samples_per_class<-(tb18S_OTUs_reads_samples_rel_abund$samples_per_class*100)/92
...
tb18_tax_occur_min49975_t<-tb18_tax_occur_min49975_no_cero
...
class_summary_reads_per_class_non.norm<-aggregate(rowSums(tb18_phototrophs_non.norm[1:92]), list(tb18_phototrophs_non.norm$SILVA_plus_MAS_plus_BM_classif), sum)
# count the different groups

class_summary_otus_per_class_non.norm<-aggregate(rowSums(tb18_phototrophs_non.norm[1:92]), list(tb18_phototrophs_non.norm$SILVA_plus_MAS_plus_BM_classif), length)
...
tb18S_OTUs_reads_samples_rel_abund_non.norm$samples_per_class<-(tb18S_OTUs_reads_samples_rel_abund_non.norm$samples_per_class*100)/92
